  ...
  module Services
    class PaymentUrl
      ...
      def confirm_webhook(webhook_url)
        @client.post("#{::PayOS::API_VERSION}/#{::PayOS::CONFIRM_WEBHOOK_PATH}", { "webhookUrl" => webhook_url })
      end
      ...
      def params_with_signature(params)
        ...
        formatted_params["signature"] = Utils::Signature.generate(string_to_sign, @client.config.checksum_secret)
